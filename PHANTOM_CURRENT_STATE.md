...
⏳ **OPEN: `.582`.** On `main` (`30f3822`), pushed, unpromoted, unstamped. **What is owed, in this
order, all of it John's from his own terminal:** `tools/promote.ps1` → hard-load the Pages URL and
confirm SYS reads `.582` → the one device check → `tools/stamp.ps1 582 VERIFIED` or `FAILED`.
...
⏳ **PARKED ON `.582`, PUSHED TO `main`, UNPROMOTED AND UNADJUDICATED (2026-09-08).** **Verify debt
