...
· SAVED`, never SYNCED; offline still `ON-DEVICE · OFFLINE`) → `tools/stamp.ps1 583 VERIFIED` or
`FAILED`. Checklist `docs/BATCH1-583-EVIDENCE.md`.
...
1. ⏳ **`.583`: `promote.ps1` → device → `stamp.ps1`.** All John's. Checklist in `docs/BATCH1-583-EVIDENCE.md`. *(`.582` closed 2026-09-08: device PASS, stamped `9a9d6db`.)*
