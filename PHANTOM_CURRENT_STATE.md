...
**Last updated: 2026-09-01, after `v1.14.562`.
✅ **NO VERIFY DEBT AND NO GAP.** `main` = `release` = served = `VERIFIED` = **`.562`**, every ship
...
| | |
|---|---|
| **Version** | **`phantom-v1.14.562`** — on `main`, on `release`, served, and stamped in `VERIFIED`. Gap 0. `forge.html` carries NO version stamp and ships outside `version.json`'s scope. |
