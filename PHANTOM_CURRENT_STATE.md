...
| Stamp | Value | Source |
|---|---|---|
| `version.json` `version` | `phantom-v1.14.413` | `version.json:2` |
| `sw.js` `CACHE_VERSION` | `phantom-v1.14.413` | `sw.js:37` |
| `dct-ios.html` `PHANTOM_APP_VERSION` | `phantom-v1.14.413` | `dct-ios.html:12751` |
