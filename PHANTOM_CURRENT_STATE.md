...
| Stamp | Value | Source |
|---|---|---|
| `version.json` `version` | `phantom-v1.14.409` | `version.json:2` |
| `sw.js` `CACHE_VERSION` | `phantom-v1.14.409` | `sw.js:37` |
| `dct-ios.html` `PHANTOM_APP_VERSION` | `phantom-v1.14.409` | `dct-ios.html:12656` |
